...
AREA_SQL_FUNCTION=$(<"$APP_DIR/sql/functions/get_area_features_for_tile.sql")
...
LINE_SQL_FUNCTION=$(<"$APP_DIR/sql/functions/get_line_features_for_tile.sql")
...
POINT_SQL_FUNCTION=$(<"$APP_DIR/sql/functions/get_point_features_for_tile.sql")
...
ROOT_SQL_FUNCTION=$(<"$APP_DIR/sql/functions/get_beefsteak_tile.sql")
...
sudo -u "$DB_USER" psql "$DB_NAME" -v ON_ERROR_STOP=1 -f "$APP_DIR/sql/functions/get_ocean_for_tile.sql"
